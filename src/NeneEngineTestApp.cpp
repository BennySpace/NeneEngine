...
//#include "../include/NeneEngineTestApp.h"
...
//int main()
//{
//    spdlog::info("NeneEngine + EnTT + EASTL is running!");
//
...
//        spdlog::info("{} located in ({:.1f}, {:.1f})", name.value.c_str(), pos.x, pos.y);
//    }
//
//    spdlog::info("EnTT is working!");
//    return 0;
//}